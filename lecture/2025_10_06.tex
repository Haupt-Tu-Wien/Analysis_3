...
\end{itemize}
    ...
    \end{itemize}
    Damit haben wir (Unser Professor alias Mathegott in der Vorlesung) gezeigt das die cofinite Topologie Tatsächlich eine 
    Topologie ist -auch wen man schon mal hinschauen muss um das zu sehen-.
    }
}
